...
# Módulo Diagnóstico Industria 4.0
    ...
    st.warning("""
        **Nota de Transparência:** As projeções de crescimento com Indústria 4.0 apresentadas abaixo utilizam como referência uma **média nacional** de ganhos de eficiência. 
        ...
        Fontes:ibge.gov.br/estatisticas/multidominio/ciencia-tecnologia-e-inovacao; portaldaindustria.com.br/estatisticas/produtividade-na-industria/; iedi.org.br; abdi.com.br/projetos/industria-4-0
    """)
